...
Build an API with Node.js (Fastify) that allows users to subscribe to email notifications about new releases of a chosen GitHub repository.
...
> **Note**: swagger.yaml file contains API documentation. **Changing the contracts is not allowed.**
...
8. Unit tests for business logic are mandatory. Integration tests are a bonus.
9. You may add comments or logic descriptions in `README.md`. Correct logic can be an advantage in evaluation if you don’t fully complete the task.
